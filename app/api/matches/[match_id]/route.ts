...
export async function GET(req: NextRequest, { params }: Params, res: NextResponse) {
    ...
    console.log('USING connection in GET match/id threadId:', connection.threadId);
    ...
    try {
        ...
        console.log('RELEASING connection in GET match/id threadId:', connection.threadId);
        connection.release();
    }
}